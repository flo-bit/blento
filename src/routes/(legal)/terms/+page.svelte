<svelte:head>
	<title>Terms of Service &middot; blento</title>
	<meta name="description" content="Terms of Service for blento." />
</svelte:head>
...
<p>
	...
	in our <a href="/imprint">Imprint</a>.
</p>
<p>
...
<ul>
	<li>
		<strong>AT Protocol (atproto):</strong> the open decentralized protocol that the Service is
		built on. See
		<a href="https://atproto.com" target="_blank" rel="noopener">atproto.com</a>.
	</li>
	<li>
		<strong>Atmosphere:</strong> the open network of applications and services built on the AT Protocol.
		Bluesky is one application in the atmosphere; blento is another.
	</li>
	<li>
		<strong>Atmosphere account:</strong> your identity on the atmosphere, represented by a DID and a handle.
	</li>
	<li>
		<strong>Personal Data Server (PDS):</strong> the server that hosts the data for your atmosphere account.
...
<ul>
	...
	<li>Publish content that infringes intellectual-property or privacy rights;</li>
	<li>Distribute malware, phishing, or other harmful material;</li>
	<li>Harass, threaten, or harm others, or incite hatred or violence;</li>
	<li>Attempt to disrupt, overload, or compromise the Service or circumvent access controls.</li>
</ul>

<h2>7. Reporting Illegal Content (DSA)</h2>
<p>
	...
	<a href="mailto:hello@blento.app">hello@blento.app</a> with:
</p>
<ul>
	<li>a substantiated explanation of why you believe the content is illegal;</li>
	<li>the exact URL(s);</li>
	<li>
		your name and email (unless reporting offences under Arts. 3&ndash;7 of Directive 2011/93/EU);
	</li>
	<li>a good-faith statement that the information is accurate and complete.</li>
</ul>
<p>
...
<p>
	...
	contractual obligation &mdash; that is, an obligation whose fulfilment makes the proper
...
<p>Any further liability for ordinary negligence is excluded.</p>
<p>
...
<p>
	...
	>. We are neither obliged nor willing to participate in a dispute-resolution procedure before a
...
<ul>
	...
	<li>
		Bluesky:
		<a href="https://bsky.app/profile/blento.app" target="_blank" rel="noopener">@blento.app</a>
	</li>
</ul>
