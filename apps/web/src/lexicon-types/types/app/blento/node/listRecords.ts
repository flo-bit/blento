...
import * as AppBlentoNode from '../node.js';

const _mainSchema = /*#__PURE__*/ v.query('app.blento.node.listRecords', {
	params: /*#__PURE__*/ v.object({
		 ...
		 */
		sort: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string<'page' | 'type' | (string & {})>()),
		/**
		 * Filter by type
		 */
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(
		/*#__PURE__*/ v.literal('app.blento.node.listRecords#profileEntry')
	),
...
const _recordSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('app.blento.node.listRecords#record')),
	...
	get value() {
		return AppBlentoNode.mainSchema;
	}
});
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'app.blento.node.listRecords': mainSchema;
	}
}
